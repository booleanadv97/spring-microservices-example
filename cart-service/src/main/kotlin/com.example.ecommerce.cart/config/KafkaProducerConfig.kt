...
class KafkaProducerConfig{
    ...
    @Bean
    fun cartEventProducerFactory(): ProducerFactory<String, CartEvent> {
    ...
    @Bean(name = ["cartEventTemplate"])
    fun cartEventTemplate(): KafkaTemplate<String, CartEvent> {
        return KafkaTemplate(cartEventProducerFactory())
    }
}